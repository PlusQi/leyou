...
public class SearchService {
    ...
    public Goods buildGoods(Spu spu) throws IOException {
        ...
        //根据分类的id查询分类名称
        List<String> names = this.categoryClient.
                queryNamesByIds(Arrays.asList(spu.getCid1(), spu.getCid2(), spu.getCid3()));
        ...
        skus.forEach(sku -> {
            ...
            //获取sku中的图片，数据库的图片可能是多张，多张是以","分隔，所以以逗号来切割返回图片数组，获取第一张图片
